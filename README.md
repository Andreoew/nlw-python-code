<p align="center">
  ...
  <img width="900px" alt="Http POST" title="Http POST" src="./http-post.png" />
  <img width="900px" alt="Código de Barra" title="Código de Barra" src="./Andre de Souza.png" />
...
<div style="display: flex; align-items: center;">
  ...
  <img src="./python.svg" width="50px" alt="Python" title="Python" style="margin-left: 10px;">
</div>
...
- [x] [Cerberus](https://cerberus.readthedocs.io/en/stable/)
- [x] [Flask](https://flask.palletsprojects.com/en/2.1.x/)
- [x] [pillow](https://pillow.readthedocs.io/en/stable/)
- [x] [pylint](https://pylint.pycqa.org/en/latest/)
- [x] [pytest](https://docs.pytest.org/en/latest/)
- [x] [python-barcode](https://python-barcode.readthedocs.io/en/stable/)
